...
const HEADLINE_LINES = ["Code", "meets", "craft."];

const BODY_COPY = [
	"I started behind a camera and a mixing board — photographing bands, engineering records deep in Florida's metal underground. That world taught me what it means to care obsessively about craft: how an image carries feeling before a word is read, how a mix either hits or it doesn't.",
	"Sudo Create is built on that foundation. The same instincts that drove the shoot drive the code — because it's the same person doing both. I build the websites, software, and infrastructure that help creative brands perform. One vision, from idea to execution.",
];
