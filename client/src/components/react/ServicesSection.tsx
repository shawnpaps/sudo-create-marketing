...
const SERVICES: Service[] = [
	{
		...
		description:
			"We build what your content deserves. Fast, media-forward websites designed to carry the story from the first frame to the final click.",
		deliverables: [
			"Astro",
			"Next.js",
			"Webflow",
	...
	},
	{
		...
		description:
			"Custom apps & tools, video delivery, integrations, and content management systems built for media-first workflows.",
		deliverables: [
			"Custom Apps",
			"Mux",
			"Video Delivery",
	...
	},
	{
		...
		description:
			"We shoot what we build for. Cinematic photography and video production for media-driven brands.",
		deliverables: [
			"Photography",
			"Video Production",
			"Brand Films",
